...
export function Nav () {
  return (
    <nav className='flex justify-center bg-white shadow w-full p-4 dark:bg-slate-900'>
        ...
        <ul className='flex gap-4 justify-center items-center'>
          <li>
            <Link href='https://github.com/Luis-Prendas' target='_blank'>
              <FaGithub className='text-3xl opacity-30 hover:opacity-100 hover:scale-105 transition dark:text-slate-200' />
            </Link>
          </li>
          <li>
            <Link href='https://www.linkedin.com/in/luisprendasdev/' target='_blank'>
              <FaLinkedin className='text-3xl opacity-30 hover:opacity-100 hover:scale-105 transition dark:text-slate-200' />
            </Link>
          </li>
          <li>
            <Link href='mailto:luisprendas.dev@gmail.com' target='_blank'>
              <SiGmail className='text-3xl opacity-30 hover:opacity-100 hover:scale-105 transition dark:text-slate-200' />
            </Link>
          </li>
        </ul>
      </div>
